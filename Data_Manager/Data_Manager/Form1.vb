...
retry:
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles btn_import.Click
        If TextBox1.Text = "" Then
            MsgBox("please Enter Tabel Name")
...
retry:
        ...
        Dim csv_file_types As String = ""

        OpenFileDialog1.Filter = "txt Files (*.txt)|*.txt"
        OpenFileDialog1.Title = "Open Your CSV_types File"
        OpenFileDialog1.RestoreDirectory = True
        OpenFileDialog1.FileName = "*_type.txt"

retry2:
        If OpenFileDialog1.ShowDialog() = DialogResult.OK Then

            csv_file_types = OpenFileDialog1.FileName
        Else
            GoTo retry2
        End If


        create_tabel(TextBox1.Text, csv_file, csv_file_types)

        AddLog("Tabel " + TextBox1.Text + "Created And Data Inserted Successfully")
